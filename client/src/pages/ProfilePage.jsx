...
const ProfilePage = () => {
    ...
    const handleSubmit = async (e)=> {
        ...
        reader.onload = async ()=> {
            const base46Image = reader.result;
            await updateProfile({profilePic: base46Image, fullName: name, bio})
            navigate("/");
        }
        ...
        justify-center">
            ...
            rounded-lg">
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-10 flex-1">
                    ...
                    <textarea  onClick={(e)=>setBio(e.target.value)} value={bio} placeholder="Write profile bio" required className="p-2 border border-gray-500

    ...
    return (
        ...
        <div className="pb-5">
            <div className="flex justify-between items-center">
                ...
                border border-gray-600 text-gray-100 hidden 
                group-hover:block">
            ...
            <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
                ...
                <input type="text" className="bg-transparent border-none outline-none text-white text-sx placeholder-[#c8c8c8] flex-1" placeholder="Search User..." />
            </div> 
        </div>
        ...
        <div className="flex flex-col">
            {userDummyData.map((user ,index)=>(
                ...
                cursor-pointer max-sm:text-sm ${selectedUser?._id === use._id && 'bg-[#282142]/50'}`}>
